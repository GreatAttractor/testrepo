...
Jako że w tym wypadku nie istnieje standardowa lokacja plików nagłówkowych i bibliotek, należy zacząć od otwarcia `config.in` i odpowiedniego ustawienia ścieżek do ww. plików.
